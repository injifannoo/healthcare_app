...
Use Case ID: UC2
Use Case Name: Healthcare Professional Scheduling
Goal: To enable healthcare professionals to manage their schedules through the app
Actor: Healthcare Professional

Flow of Events:
    1. The healthcare professional opens the mobile app.
    2. The app displays the home page.
    3. The healthcare professional selects the "Schedule" option from the menu.
    4. The app displays the upcoming appointments and availability.
    5. The healthcare professional approves or reschedules appointments as needed.
    6. The app updates the schedule accordingly.
    7. The app sends notifications to patients regarding any changes in their appointments.
    8. End of the use case.
Use Case ID: UC3
Use Case Name: Patient Inquiries and Consultations
Goal: To facilitate communication between patients and healthcare professionals through the app
Actor: Patient, Healthcare Professional

Flow of Events:
    1. The patient opens the mobile app.
    2. The app displays the home page.
    3. The patient selects the "Messages" or "Consultations" option from the menu.
    4. The app displays the message or consultation interface.
    5. The patient submits health-related questions or requests for consultations.
    6. The healthcare professional receives the inquiry or consultation request.
    7. The healthcare professional reviews the information and responds via secure messaging or initiates a video call.
    8. The patient and healthcare professional exchange information and discuss the healthcare concerns.
    9. The app maintains a record of the communication for reference.
    10. End of the use case.
Use Case ID: UC4
Use Case Name: Progress Tracking and Monitoring
Goal: To enable healthcare professionals to track and monitor patient progress through the app
Actor: Healthcare Professional

Flow of Events:
    1. The healthcare professional opens the mobile app.
    2. The app displays the home page.
    3. The healthcare professional selects the patient's profile or relevant section for progress tracking.
    4. The app displays the patient's health data, such as vital signs, test results, or treatment outcomes.
    5. The healthcare professional updates the data as needed.
    6. The app saves the updated information.
    7. The healthcare professional uses the data to provide personalized care, track improvements, and intervene if necessary.
    8. End of the use case.
Use Case ID: UC5

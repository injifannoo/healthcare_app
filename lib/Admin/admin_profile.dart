...
import 'package:healthcare_app/Admin/Edit_admin_profile.dart';
...
class _DoctorProfilePageState extends State<AdminProfile> {
  ...
  Future<void> _getAdminProfile() async {
    ...
    if (_admin != null) {
      DocumentSnapshot userSnapshot =
          await _firestore.collection('Admins').doc(_admin!.uid).get();
      setState(() {
  ...
  void _editProfile() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => const EditAdminProfile(),
      ),
    ).then((updatedProfile) {
